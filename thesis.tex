...
\mdchap{Contents of the KSI web application}
...
The primary task of this thesis was to create a new web application for the Online Seminar of Informatics. The new web application was supposed to be 
