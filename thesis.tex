...
The KSI participants will spend most of their time on pages containing tasks. Every task has an assignment text, in which the subject of a given task is first explained and then examined in so-called modules. Modules can take the following forms:
...
\begin{figure}
\includegraphics[width=.5\textwidth]{assets/img/Questionnaire/device}
...
\begin{figure}
\includegraphics[width=\textwidth]{assets/img/Questionnaire/faster}
\caption{Questionnaire: I find the new KSI web faster than the current}
\label{fig:q-speed}
\end{figure}
...
\begin{figure}
\includegraphics[width=\textwidth]{assets/img/Questionnaire/pc-ux}
\caption{Questionnaire: My experience with the new KSI web on desktop is better}
\label{fig:q-ux-pc}
\end{figure}

\begin{figure}
\includegraphics[width=\textwidth]{assets/img/Questionnaire/mobile-ux}
\caption{Questionnaire: My experience with the new KSI web on mobile is better}
\label{fig:q-ux-mobile}
\end{figure}

\begin{figure}
\includegraphics[width=\textwidth]{assets/img/Questionnaire/pc-ui}
\caption{Questionnaire: The design of the new KSI web interface on desktop is better}
\label{fig:q-ui-pc}
\end{figure}

\begin{figure}
\includegraphics[width=\textwidth]{assets/img/Questionnaire/mobile-ui}
\caption{Questionnaire: The design of the new KSI web interface on mobile is better}
