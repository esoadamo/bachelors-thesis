...
React.js~[@reactjs] is a web framework that introduces its own syntax called JSX. JSX is a syntax extension of JavaScript, which allows writing \acrshort{HTML} templates together with JavaScript logic~[@reactjs-main-concepts]:
