...
From this code example, it is evident, that the backend is expecting a JSON dictionary with a single key `post`, which contains additional dictionary with keys `author` and `body`. This can 
